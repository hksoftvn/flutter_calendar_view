...
class MonthViewState<T extends Object?> extends State<MonthView<T>> {
  ...
  Widget _defaultHeaderBuilder(DateTime date,double width,double height) {
  ...
  Widget _defaultWeekDayBuilder(int index, {bool? onWeekday = true}) {
    return WeekDayTile(
      dayIndex: index,
  ...
  Widget _defaultCellBuilder(
    ...
    return FilledCell<T>(
      ...
      highlightColor: Color(0xff3B0168),
    );
  }
